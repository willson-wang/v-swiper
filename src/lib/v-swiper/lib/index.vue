<template>
    <div class="swiper-wrap" ref="swiper" :class="className" :style="{ height }">
        <div
            ...
            ref="swiperContent"
            :style="styleObj"
            :class="[isTransition ? 'swiper-transition' : '']"
        >
            <div
        ...
        styleObj() {
            ...
            const width =
                this.direction === 'horizontal'
                    ? parseInt(this.width) * this.newList.length + 'px'
                    : '100%'
            return {
                width,
    ...
    data() {
        ...
        const initTransform =
            this.direction === 'horizontal'
                ...
                : parseFloat(height)
        const width =
            this.direction === 'horizontal' ? this.initWidth || window.innerWidth + 'px' : '100%'
        return {
            width,
    ...
    methods: {
        ...
        remHeightToPx() {
            let htmlFontSize =
                ...
                '75px'
            let reg = /rem/gi
            return reg.test(this.height)
                ? parseFloat(this.height) * parseInt(htmlFontSize)
                : this.height
        }
    },
    mounted() {
